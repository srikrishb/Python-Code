                ...
                if itemkey != 'outputFileName' and itemkey != 'email':
                    ...
                    for i in range(0, len(targetData)):
                        ...
                        for listIndex in range(0, len(attributesResponseList)):
                            ...
                            listOfAttributesFromResponse.append(attributeResponseMap['labelReference']['signifier'])

                        print(listOfAttributesFromResponse)
                        listOfAttributesFromResponse = list(set(listOfAttributesFromResponse))
                        print(listOfAttributesFromResponse)
                        for possibleAttribute in possibleAttributesList:
                            for listIndex in range(0,len(attributesResponseList)):
                                attributeResponseMap = attributesResponseList[listIndex]
                                print(possibleAttribute, listOfAttributesFromResponse)
                        ...
                        if bool(targetDataAttributesMap):
                           print(createTargetDataFile(targetDataAttributesMap, eachKey, '.csv'))

                        if bool(targetDataRelationsMap):
                           print(createTargetDataFile(targetDataRelationsMap, eachKey, '.csv'))

                        if bool(targetDataComplexRelationsMap):
                           print(createTargetDataFile(targetDataComplexRelationsMap, eachKey, '.csv'))
                    ...
                    for i in range(0,len(targetData)):
                        ...
                        fileNameList.append(createTargetDataFile(targetDataMap, outputFileName, '.csv'))
