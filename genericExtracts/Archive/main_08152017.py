        ...
        for itemkey in eachMap.keys():
            ...
            if isinstance(eachMap[itemkey], dict):
                ...
                if itemkey != 'outputFileName' and itemkey != 'email':
                    ...
                    filePath = 'K:/Git Code/Python/Output/'+outputFileName
                    print(filePath)
                    ...
                    if os.path.isfile(filePath):
                        ...
                        composedMessage = MIMEMultipart('alternative')
                        ...
                        #msg.add_header('Content-ID', '<{}>'.format(outputFileName))
                        msg['Content-Disposition'] = 'attachment; filename="%s"' % basename(outputFileName)
