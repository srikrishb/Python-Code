                ...
                if itemkey != 'outputFileName' and itemkey != 'email':
                    ...
                    for i in range(0, len(targetData)):
                        ...
                        if bool(targetDataRelationsMap):
                            createTargetDataFile(targetDataRelationsMap, eachKey, '-Relations.csv')

                        if bool(targetDataAttributesMap):
                            createTargetDataFile(targetDataAttributesMap, eachKey, '-Attributes.csv')

                        if bool(targetDataComplexRelationsMap):
                            createTargetDataFile(targetDataComplexRelationsMap, eachKey, '-ComplexRelations.csv')
