                ...
                if itemkey != 'outputFileName' and itemkey != 'email':
                    ...
                    for i in range(0, len(targetData)):
                        ...
                        if possibleRelationsAndAttributesResponse != 'No Data Found':
                            ...
                            print(possibleRelationAttributesList)
                            #print(possibleRelationsAndAttributesList)

                        # Find the Complex Relations and Attributes
                        targetDataComplexRelationMap['signifier'] = targetData[i]['signifier']
                        ...
                        if complexRelationsMap != 'No Data Found' and complexRelationsMap != 'No Relations Found':
                            ...
                            for j in range(0, len(complexRelationsMap['relationReference'])):
                                ...
                                if relationKey in targetDataComplexRelationMap.keys():
                                    relationValue = targetDataComplexRelationMap[relationKey]
                                relationValue.append(relationReferenceList['targetReference']['signifier'])
                                targetDataComplexRelationMap[relationKey] = relationValue
                                relationValue = []
                        ...
                        if complexRelationsAttributesMap != 'No Attributes Found':
                            ...
                            for j in range(0, len(complexRelationsAttributesMap['attributeReferences']['attributeReference'])):
                                ...
                                if attributeKey in targetDataComplexRelationMap.keys():
                                    attributeValue = targetDataComplexRelationMap[attributeKey]
                                attributeValue.append(attributesReferenceList['value'])
                                targetDataComplexRelationMap[attributeKey] = attributeValue
                                attributeValue = []
                    ...
                    targetFileName = 'K:/Git Code/Python/Output/' + targetDataComplexRelationMap['signifier'] + '_ComplexRelations.csv'
                    targetFile = open(targetFileName, 'w', newline='')
                    csvWriter = csv.writer(targetFile, delimiter=',')

                    targetFileHeader = []
                    for key in targetDataComplexRelationMap.keys():
                    ...
                    targetFileRow = []
                    for key in targetDataComplexRelationMap.keys():
                        if isinstance(targetDataComplexRelationMap[key], list):
                            writeString = ','.join(str(x) for x in targetDataComplexRelationMap[key])
                        else:
                            writeString = targetDataComplexRelationMap[key]
